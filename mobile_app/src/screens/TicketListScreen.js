...
const styles = StyleSheet.create({
  ...
  emptyContainer: { flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: '#0A1017' },
  searchInput: {
    margin: 12,
  ...
  placa: { fontSize: 18, fontWeight: 'bold', color: '#fff', letterSpacing: 1 },
  badge: { paddingHorizontal: 10, paddingVertical: 3, borderRadius: 20 },
  badgeText: { fontSize: 11, fontWeight: '700', textTransform: 'uppercase' },
  codigo: { fontSize: 12, color: '#94a3b8', marginBottom: 4 },
  motivo: { fontSize: 14, color: '#fff', marginBottom: 8 },
  cardBottom: { flexDirection: 'row', justifyContent: 'space-between' },
  meta: { fontSize: 12, color: '#94a3b8' },
  errorText: { color: '#ef4444', marginBottom: 16, textAlign: 'center' },
  retryBtn: { backgroundColor: '#D4920A', paddingHorizontal: 24, paddingVertical: 10, borderRadius: 8 },
  retryText: { color: '#0A1017', fontWeight: '700' },
