...
class SecurityDetectionService:
    ...
    def detect_brute_force(
        self, ip_address: str, time_window_minutes: int = 10, max_attempts: int = 5
    ) -> bool:
        """
        ...
        failed_attempts = self.audit_log_repo.count_by_action_and_ip(
            action=AuditAction.LOGIN_FAILED, ip_address=ip_address, since=cutoff_time
        )
    ...
    def detect_password_reset_abuse(
        self, email: str, time_window_hours: int = 1, max_requests: int = 3
    ) -> bool:
        """
