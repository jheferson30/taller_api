...
from app.utils.i18n import convertir_a_timezone, formatear_moneda
...
# â”€â”€ Paleta (misma que pdf_generator.py) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
def generar_pdf_economia_profesional(
    ...
    def _fmt(valor) -> str:
        ...
        """Formatea un valor monetario usando el contexto regional del taller."""

        return formatear_moneda(valor, moneda, idioma)
    ...
    # â”€â”€ Datos del taller â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    fecha_gen = convertir_a_timezone(datetime.now(tz=_UTC), timezone).strftime("%d/%m/%Y %H:%M")
    ...
    logo_url_taller = dt.get("logo_url") or ""
    ...
    # â”€â”€ RESUMEN EJECUTIVO â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # â”€â”€ ESTADÍSTICAS DEL DÍA â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # â”€â”€ ANTICIPOS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        for a in anticipos:
            ...
            rows.append(
                ...
                [
                    ...
                    Paragraph(a.get("ticket_codigo") or "â€”", s_small),

                    Paragraph(a.get("placa") or "â€”", s_valor),

                    Paragraph(a.get("metodo_pago") or "â€”", s_valor),

                    Paragraph(a.get("responsable") or "â€”", s_valor),

                    Paragraph(_fmt(a.get("valor_anticipo", 0)), s_valor_r),
    ...
    # â”€â”€ COBROS FINALES â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        for c in cobros_finales:
            ...
            rows.append(
                ...
                [
                    ...
                    Paragraph(c.get("ticket_codigo") or "â€”", s_small),

                    Paragraph(c.get("placa") or "â€”", s_valor),

                    Paragraph(c.get("metodo_pago") or "â€”", s_valor),

                    Paragraph(c.get("responsable") or "â€”", s_valor),

                    Paragraph(_fmt(c.get("valor_final_cobrado", 0)), s_valor_r),
    ...
    # â”€â”€ COBROS RÁPIDOS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        for r in cobros_rapidos:
            ...
            rows.append(
                ...
                [
                    ...
                    Paragraph(r.get("descripcion") or "â€”", s_valor),

                    Paragraph(r.get("placa") or "â€”", s_valor),

                    Paragraph(r.get("metodo_pago") or "â€”", s_valor),

                    Paragraph(_fmt(r.get("valor", 0)), s_valor_r),
    ...
    # â”€â”€ EGRESOS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        for cat, items in por_cat.items():
            ...
            rows_cat.append(
                ...
                [
                    ...
                    Paragraph(_fmt(total_cat), s_valor_r),
        ...
        for e in egresos:
            ...
            rows_det.append(
                ...
                [
                    ...
                    Paragraph(str(e.get("concepto") or "â€”")[:45], s_valor),

                    Paragraph(str(e.get("ticket_codigo") or "â€”")[:22], s_small),

                    Paragraph(str(e.get("responsable") or "â€”")[:20], s_valor),

                    Paragraph(_fmt(e.get("valor", 0)), s_valor_r),
    ...
    # â”€â”€ PIE DE PÁGINA â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    story.append(
        ...
        Paragraph(
            ...
            f"Reporte generado el {convertir_a_timezone(datetime.now(tz=_UTC), timezone).strftime('%d/%m/%Y a las %H:%M')}  â€¢  "

            f"Período: {fecha_fmt}  â€¢  {nombre_taller}",
