...
from app.modelos import (
    ...
    TokenBlacklist, PasswordResetToken, ConfiguracionSeguridad
)
...
from scripts.migrate_passwords import migrate_passwords, get_username_from_clave, MigrationReport
...
def test_migrate_passwords_success(db_session: Session):
    ...
    assert economia_user.password_hash == "5e884898da28047151d0e56f8dc6292773603d0d6aabbdd62a11ef721d1542d8"
    ...
    assert admin_user.password_hash == "6ca13d52ca70c883e0f0bb101e425a89e8624de51db2d2392593af6a84118090"
