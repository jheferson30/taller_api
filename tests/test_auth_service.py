...
class TestAuthenticate:
    ...
    def test_authenticate_with_sha256_migrates_to_bcrypt(
        self, auth_service, sample_user_sha256, user_repo, password_hasher
    ):
...
class TestRefreshAccessToken:
    ...
    def test_refresh_token_generates_new_access_token(
        self, auth_service, sample_user_bcrypt, token_manager
    ):
    ...
    def test_refresh_token_blacklisted_fails(
        self, auth_service, sample_user_bcrypt, token_manager, token_blacklist_repo
    ):
...
class TestResetPassword:
    ...
    def test_reset_password_with_valid_token(
        self, auth_service, sample_user_bcrypt, user_repo, password_hasher
    ):
    ...
    def test_reset_password_with_used_token_fails(self, auth_service, sample_user_bcrypt):
