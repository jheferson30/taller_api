...
class TestErrorMessages:
    ...
    def test_password_reset_does_not_reveal_email_existence(self, client, db_session, test_user):
        ...
        response_existing = client.post("/auth/forgot-password", json={"email": test_user.email})
    ...
    def test_insufficient_permissions_error_is_clear(self, client, db_session):
