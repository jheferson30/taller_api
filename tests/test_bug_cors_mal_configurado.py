...
class TestCORSMalConfigurado:
    ...
    def test_cors_permite_credenciales_con_wildcard(self):
        ...
        try:
            ...
            tiene_wildcard = '_origins' in contenido and '["*"]' in contenido or "_origins" in contenido and "['*']" in contenido
        ...
        for archivo in archivos_env:
            try:
                ...
                if tiene_allowed_origins:
                    ...
                    tiene_valores_seguros = (
                        'https://' in contenido and 
                        'taller.com' in contenido
                    )
