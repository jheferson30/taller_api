...
class TestAusenciaProteccionCSRF:
    ...
    def test_post_sin_csrf_token_es_aceptado(self, api_base_url, auth_token):
        ...
        try:
            ...
            response = requests.post(
                ...
                json={
                    "nombre": "Test CSRF",
                    "descripcion": "Test CSRF - Proceso de prueba"
                },
                timeout=5
            )
            ...
            print(f"  Esto confirma que NO hay protección CSRF implementada")
    ...
    def test_main_no_tiene_configuracion_csrf(self):
        ...
        try:
            ...
            tiene_import_csrf = (
                'fastapi_csrf_protect' in contenido or
                'CsrfProtect' in contenido or
                'csrf_protect' in contenido
            )
            
            # Buscar configuración de CSRF
            tiene_config_csrf = (
                'CsrfSettings' in contenido or
                'csrf_secret' in contenido.lower() or
                'CsrfProtectError' in contenido
            )
    ...
    def test_rutas_no_validan_csrf(self):
        ...
        for archivo in archivos_rutas:
            try:
                ...
                tiene_csrf_protect = (
                    'CsrfProtect' in contenido or
                    'csrf_protect' in contenido or
                    'validate_csrf' in contenido
                )
    ...
    def test_frontend_no_envia_csrf_token(self):
        ...
        for archivo in archivos_frontend:
            try:
                ...
                tiene_csrf_config = (
                    'X-CSRF-Token' in contenido or
                    'csrf' in contenido.lower() or
                    'getCsrfToken' in contenido
                )
