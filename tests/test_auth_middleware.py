...
class TestAuthMiddleware:
    ...
    def test_protected_endpoint_with_valid_token(
        self, app_with_middleware, sample_user_with_roles, token_manager
    ):
    ...
    def test_protected_endpoint_with_expired_token(
        self, app_with_middleware, sample_user_with_roles
    ):
    ...
    def test_protected_endpoint_with_blacklisted_token(
        self, app_with_middleware, sample_user_with_roles, token_manager, db_session
    ):
    ...
    def test_middleware_with_invalid_authorization_header_format(self, app_with_middleware):
...
class TestRequireRoleDecorator:
    ...
    def test_require_role_without_matching_role(
        self, app_with_middleware, sample_user_no_roles, token_manager
    ):
